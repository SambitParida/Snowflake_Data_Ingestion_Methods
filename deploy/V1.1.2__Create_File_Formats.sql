...
create or replace file format customer_tsv_ff type = 'csv' compression = 'auto' field_delimiter = '\t' record_delimiter = '\n' skip_header = 1 field_optionally_enclosed_by = '"' null_if = ('\\n','\\N','');

-- Create PSV File format -- 
create or replace file format customer_psv_ff type = 'csv' compression = 'auto' field_delimiter = '|' record_delimiter = '\n' skip_header = 1 field_optionally_enclosed_by = '"' null_if = ('\\n','\\N','');