...
create or replace transient table customer_csv_multiple (
...
copy into ch02.customer_csv_multiple (
    customer_pk,
    salutation,
    first_name,
    last_name,
...
from (
        ...
        from @~/customer/csv/uncompressed/ t
    ) file_format = (format_name = 'ttips.ch02.customer_csv_ff') 
    on_error = 'CONTINUE'
    pattern = '.*[.]csv'
    ;
